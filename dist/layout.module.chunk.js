...
var EditPostComponent = /** @class */ (function () {
    ...
    EditPostComponent.prototype.ngOnInit = function () {
        ...
        this.form = this.formBuilder.group({
            name: [this.name, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            description: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            condition: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            image: [this.image, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            itemName: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            location: [''],
            fbId: [this.fbId, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required]
        });
...
var PostItemComponent = /** @class */ (function () {
    ...
    PostItemComponent.prototype.ngOnInit = function () {
        ...
        this.form = this.formBuilder.group({
            ...
            image: [this.image, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            itemName: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            location: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
            fbId: [this.fbId, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["l" /* Validators */].required],
