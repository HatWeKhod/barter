...
var EditPostComponent = /** @class */ (function () {
    function EditPostComponent(formBuilder, router, postService, sanitizer, route) {
    ...
    EditPostComponent.prototype.ngOnInit = function () {
        ...
        this.form = this.formBuilder.group({
            name: [this.name, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            description: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            condition: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            image: [this.image, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            itemName: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            location: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            fbId: [this.fbId, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required]
        });
    ...
    EditPostComponent.prototype.trackMe = function () {
        var _this = this;
    ...
    EditPostComponent.prototype.showTrackingPosition = function (position) {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(postService, _sanitizer, dialog) {
        this.postService = postService;
        this._sanitizer = _sanitizer;
        this.dialog = dialog;
        this.all_post_list = [];
...
var PostItemComponent = /** @class */ (function () {
    function PostItemComponent(formBuilder, router, postService, sanitizer) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.postService = postService;
        this.sanitizer = sanitizer;
